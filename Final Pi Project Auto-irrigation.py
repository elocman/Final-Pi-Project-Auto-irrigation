...
class MainGUI(Frame):
    ...
    def setupGUI(self):
        ...
        # apply button
        self.button3 = Button(self, text="Tips & Facts", command=secret)
        ...
        def update():
            # time setup
            hourTime = 7 #dt.datetime.now().hour
            minuteTime = 0 #dt.datetime.now().minute
...
niceMesg = ["Remember to water...oh wait\n you don't have to.",
            "Plants helped reduce the stress\n caused by this project.",
            "Use compost to fertilize or poop.",
            "The dandelion is completely\n edible from petals to roots.",
            "Trees are the longest-living\n organisms on Eartrh, even older\n than Tech's servers.",
            "Planting trees helps the environment,\n or something.",
            "Lots of plants are used medicinally,\n my friends use them recreationally.",
